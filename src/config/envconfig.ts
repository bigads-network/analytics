...
const envVarsSchema = z.object({
  ...
  XDC_PRIVATEKEY_XDC5:z.string().optional(),
  ADMIN_PRIVATEKEY_XDC6:z.string().optional(),
  ADMIN_PRIVATEKEY_XDC7:z.string().optional(),
  ADMIN_PRIVATEKEY_XDC8:z.string().optional(),
  ADMIN_PRIVATEKEY_XDC9:z.string().optional(),
...
export const envConfigs = {
  ...
  // Removed: adminPrivatKey_Xdc5-9 (using only 5 admins now)
